...
const personalInfo = [
  ...
  { label: "Focus Areas", value: "Software Development, Web Development, IT Support" },
];

// --- Tech Skills ---
const techCategories = [
  { title: "Programming Languages", items: ["Java", "Python", "SQL"] },
  { title: "Frameworks & Libraries", items: ["Spring Boot", "Next.js", "React", "Angular"] },
  { title: "Database Management", items: ["MySQL", "Oracle"] },
  { title: "API Development", items: ["RESTful APIs", "Postman"] },
  { title: "Cloud & Tools", items: ["Oracle Cloud", "Maven", "Git", "Docker (Basic)"] },
  { title: "Frontend Craft", items: ["HTML", "CSS", "JavaScript", "TypeScript", "UI/UX Design"] },
];
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Software Engineer passionate about building modern, reliable web solutions and AI-driven systems." />
      </Head>
      ...
      <main className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 text-white px-6 py-12">
        <div className="max-w-6xl mx-auto">
          ...
          <section className="mb-12 grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
            ...
            <motion.div className="col-span-2 space-y-5" variants={stagger} initial="hidden" whileInView="show" viewport={{ once: true }}>
              <motion.h1 variants={fadeIn} className="text-4xl md:text-5xl font-extrabold tracking-tight">
              ...
              <motion.p variants={fadeIn} className="text-lg max-w-2xl text-slate-200">
                I’m a Software Engineer passionate about building intuitive, scalable web applications with a strong foundation in backend architecture and AI-powered solutions.
              </motion.p>
          ...
          <section className="mb-12 bg-gradient-to-br from-white/5 to-transparent p-6 rounded-3xl ring-1 ring-white/10 shadow-xl">
            <motion.h2 variants={fadeIn} initial="hidden" whileInView="show" className="text-2xl md:text-3xl font-semibold mb-4">
              Core Values & Work Philosophy
            </motion.h2>
            <motion.p variants={fadeIn} className="text-slate-300 leading-relaxed max-w-3xl">
              I believe in crafting software that solves real problems through simplicity, performance and accessibility. 
              I value collaboration, continuous learning and code that is both elegant and maintainable.
            </motion.p>
          </section>
                ...
                <motion.article key={c.id} variants={pop} whileHover={{ y: -6 }} className="p-4 rounded-2xl bg-gradient-to-br from-slate-800/60 to-slate-700/40 ring-1 ring-white/6 shadow-lg">
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="mt-3 flex items-center gap-3">
                      <button onClick={() => setViewCert(c.file)} className="px-3 py-1.5 rounded-full bg-gradient-to-r from-blue-500/80 to-purple-500/80 text-white text-sm font-medium shadow hover:scale-105 transition">
                        View
                      </button>
                      <a href={c.file} download className="px-3 py-1.5 rounded-full border border-white/10 text-sm text-slate-100 hover:bg-white/4 transition">
                        Download
                      </a>
                    </div>
                  </div>
          ...
          <section className="mb-24">
            ...
            <motion.div variants={stagger} initial="hidden" whileInView="show" className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {timelineItems.map((item, idx) => (
                <motion.article key={item.title} variants={fadeIn} whileHover={{ scale: 1.03, y: -6 }} className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-slate-800/70 to-slate-700/50 p-0 ring-1 ring-white/6 shadow-2xl">
...
//     date: "2021",
//     title: "University of Zimbabwe",
//     description: "B.Sc. Software Engineering — foundational and advanced modules.",
//     image: "/uz.jpg",
//   },
//   {
//     date: "Aug 2023 – Aug 2024",
//     title: "Afrosoft Holdings",
//     description: "Software Developer Intern — gained hands-on experience in building production-grade systems.",
//     image: "/afro.jpg",
//   },
//   {
//     date: "2025",
...
//     type: "Certification",
//     file: "/certs/eCertificate_1.jpg",
//     notes: "Validated skills in AI concepts, responsible AI, and Oracle Cloud AI tools.",
//   },
//   {
//     id: "data-eng",
//     title: "Introduction to Data Engineering and Big Data",
...
// // --- Skill Pill ---
// const SkillPill = ({ name }: { name: string }) => (
//   <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-sm font-medium bg-white/5 backdrop-blur-sm border border-white/10 hover:scale-105 transition-transform">
//     {name}
//   </span>
// );
...
//         <meta
//           name="description"
//           content="Learn more about Tirivashe Tinarwo — a software engineer skilled in web development, APIs, and data-driven systems."
//         />
//       </Head>
...
//               <motion.p variants={fadeIn} className="text-lg max-w-2xl text-slate-300 leading-relaxed">
//                 I’m a Software Engineer passionate about building clean, efficient, and modern
//                 web applications — combining solid backend logic with engaging, responsive UI.
//               </motion.p>
...
//           {/* SKILLS */}
//           <section className="bg-gradient-to-br from-white/5 to-white/3 p-6 rounded-3xl ring-1 ring-white/10 shadow-lg">
//             <motion.h2 variants={fadeIn} initial="hidden" whileInView="show" className="text-2xl md:text-3xl font-semibold mb-6">
//               Technical Skills
//             </motion.h2>
...
//             <motion.div variants={stagger} initial="hidden" whileInView="show" className="grid gap-6 md:grid-cols-2">
//               {techCategories.map((cat) => (
//                 <motion.div key={cat.title} variants={fadeIn} className="p-4 rounded-2xl bg-slate-800/50 ring-1 ring-white/10">
//                   <h3 className="text-lg font-semibold mb-3 text-slate-100">{cat.title}</h3>
//                   <div className="flex flex-wrap gap-3">
//                     {cat.items.map((tech) => (
//                       <SkillPill key={tech} name={tech} />
//                     ))}
...
//             <motion.div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
//               {certifications.map((c) => (
//                 <motion.article key={c.id} variants={pop} whileHover={{ y: -6 }} className="p-5 rounded-2xl bg-slate-800/60 ring-1 ring-white/10 shadow-lg hover:ring-white/20 transition">
//                   <div className="flex flex-col gap-2">
//                     <div>
//                       <h3 className="text-md font-semibold text-slate-100">{c.title}</h3>
//                       <p className="text-sm text-slate-300">{c.issuer}</p>
//                       <p className="text-xs text-slate-400 mt-1">{c.dateRange} • {c.type}</p>
//                     </div>
...
//                         className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-gradient-to-r from-blue-500/80 to-purple-500/80 text-white text-sm font-medium shadow hover:scale-105 transition"
//                       >
//                         View
//                       </button>
//                       <a
//                         href={c.file}
//                         download
//                         className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-white/10 text-sm text-slate-100 hover:bg-white/5 transition"
//                       >
//                         Download
//                       </a>
//                     </div>
...
//             {viewCert && (
//               <div className="fixed inset-0 z-50 flex items-center justify-center p-6">
//                 <div className="absolute inset-0 bg-black/70" onClick={() => setViewCert(null)} />
//                 <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.25 }} className="relative w-full max-w-4xl h-[80vh] bg-slate-900 rounded-2xl ring-1 ring-white/10 overflow-hidden">
//                   <div className="flex items-center justify-between p-3 bg-slate-800/80">
//                     <div className="text-sm text-slate-200">Viewing certificate</div>
//                     <div className="flex items-center gap-2">
//                       <button onClick={() => openInNewTab(viewCert)} className="text-sm px-3 py-1 rounded-md border border-white/10">Open in new tab</button>
//                       <button onClick={() => setViewCert(null)} className="text-sm px-3 py-1 rounded-md bg-white/10">Close</button>
//                     </div>
//                   </div>
//                   <iframe src={viewCert} title="certificate viewer" className="w-full h-full" />
//                 </motion.div>
...
//             <motion.div variants={stagger} initial="hidden" whileInView="show" className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
//               {timelineItems.map((item, idx) => (
//                 <motion.article key={item.date + item.title} variants={fadeIn} whileHover={{ scale: 1.03, y: -6 }} className="relative rounded-3xl overflow-hidden bg-slate-800/60 ring-1 ring-white/10 shadow-2xl">
//                   <motion.div initial={{ opacity: 0, scale: 0.98 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5, delay: idx * 0.12 }} className="relative w-full aspect-square">
//                     <Image src={item.image} alt={item.title} fill style={{ objectFit: "cover" }} sizes="(max-width: 768px) 100vw, 33vw" />
...
//                       <button
//                         type="button"
//                         className="ml-auto text-sm px-3 py-1 border border-white/10 rounded-full text-slate-100 hover:bg-white/5 transition"
